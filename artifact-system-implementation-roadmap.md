...
├── course.json
└── 1-fundamentals/
    ├── 1.1 Введение - что такое артефакты.md
    ├── 1.2 Графики (Plotly) - типы и примеры.md
    ├── 1.3 Калькуляторы (Math.js) - параметры и формулы.md
    ├── 1.4 Создание артефактов через AI.md
    └── 1.5 Галерея шаблонов - справочник.md
```
