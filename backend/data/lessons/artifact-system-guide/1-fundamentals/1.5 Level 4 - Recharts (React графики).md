...
**⚠️ Обрати внимание:** Этот урок содержит **теоретическое** объяснение Recharts. Работающие примеры требуют добавления поддержки React компонентов в систему артефактов.
...
**Что будет добавлено:** (см. `react-artifacts-roadmap.md`)
- 🔮 Работающие интерактивные примеры Recharts
- 🔮 Возможность открыть график прямо в уроке

**Пока используй:** Level 3 артефакты (Plotly.js) для практики.
