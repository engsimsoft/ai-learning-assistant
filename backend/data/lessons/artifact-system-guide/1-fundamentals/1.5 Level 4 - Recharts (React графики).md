...
**Линейный график:**
👉 [Recharts Line Chart - Мощность двигателя](artifact:recharts-line)

**Столбчатая диаграмма:**
👉 [Recharts Bar Chart - Сравнение типов двигателей](artifact:recharts-bar)

Откройте артефакты выше, чтобы увидеть **реальные работающие примеры** Recharts!
