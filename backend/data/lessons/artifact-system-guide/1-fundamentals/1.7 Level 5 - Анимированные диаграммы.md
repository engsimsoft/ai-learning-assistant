...
**👉 [Открыть P-V диаграмму (Анимированная)](artifact:pv-diagram)**

Нажми на ссылку выше, чтобы открыть **полностью работающую анимированную диаграмму** цикла Отто!

**Что можно делать:**
- ▶️ Запустить анимацию (кнопка Play)
- ⏸️ Остановить в любой момент (Pause)
- 🔄 Сбросить в начало (Reset)
- 🎚️ Изменить степень сжатия (6-12)
- 📊 Изменить максимальное давление (3-6 bar)
